...
import { useCategory, useCreateCategory, useUpdateCategory } from "./useInventoryCrud";
      ...
      <Card>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
            <Input label="Name" placeholder="Stationery" error={errors.name?.message} {...register("name")} />
            <Input label="Description" error={errors.description?.message} {...register("description")} />

            <div className="mt-2 flex justify-end gap-3">
              <Button type="button" variant="secondary" onClick={() => navigate("/inventory/categories")}>
                Cancel
              </Button>
